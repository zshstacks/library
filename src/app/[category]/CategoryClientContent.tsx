...
function ArticleRow({
  ...
  return (
    <Link
      ...
      className="group block anim-fade-in-up"
    >
      <div className="flex items-start justify-between gap-4 px-4 py-4 rounded-lg border border-white/[0.06] dark:border-gray-800/12 bg-white/[0.03] dark:bg-white/35 hover:bg-white/[0.07] dark:hover:bg-white/50 hover:border-white/15 dark:hover:border-gray-800/25 transition-all duration-200 hover:-translate-y-px">
        <div className="flex-1 min-w-0">
          <h3
            className="font-semibold text-[15px] mb-1 group-hover:underline group-hover:underline-offset-4"
        ...
        <MdOutlineNavigateNext
          size={18}
          className="text-white/20 dark:text-gray-800/20 group-hover:text-white/50 dark:group-hover:text-gray-800/50 transition-all mt-0.5 flex-shrink-0 group-hover:translate-x-0.5 duration-200"
        />
      </div>
    </Link>
  );
  ...
  return (
    <main className="min-h-screen text-white/80 dark:text-gray-800">
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 pt-[88px] pb-16">
        <nav className="flex items-center gap-2 text-sm mb-8 anim-fade-in-up anim-delay-0">
          <Link
            href="/"
        ...
        <section className="anim-fade-in-up anim-delay-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="relative group flex-1 max-w-[240px] ml-4">
              <MdSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-white/20 dark:text-gray-800/20 group-focus-within:text-white/50 transition-colors" />
              <input
                type="text"
                placeholder="Search..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full bg-white/5 dark:bg-black/5 border border-white/8 dark:border-gray-800/12 rounded-lg py-1.5 pl-9 pr-4 text-xs focus:outline-none focus:border-white/20 transition-all"
              />
            </div>
          </div>
